/* TRANSFORMATIONS.
	...
	- coloring the primitives using uniform variables and the fragment shader
	- using GL_QUADS to draw a rectangle
*/
...
glm::mat4 myMatrix, resizeMatrix, matrTransl, matrTransl1, matrTransl2, matrScale, matrRot;
...
void RenderFunction(void)
{
	...
	// initial rectangle
	// the matrix for establishing the position
	myMatrix = resizeMatrix;
	myMatrixLocation = glGetUniformLocation(ProgramId, "myMatrix");
	glUniformMatrix4fv(myMatrixLocation, 1, GL_FALSE, &myMatrix[0][0]);
