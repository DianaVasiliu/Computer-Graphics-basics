...
glm::mat4 myMatrix, resizeMatrix, matrTransl, matrTransl2, matrTransl3, matrScale1, matrScale2, matrRot, matrMove;
...
void RenderFunction(void)
{
    ...
    matrTransl = glm::translate(glm::mat4(1.0f), glm::vec3(i / 2, i, 0.0));		// y = x/2
    matrTransl2 = glm::translate(glm::mat4(1.0f), glm::vec3(-i / 2, i, 0.0)); // y = -x/2
    matrTransl3 = glm::translate(glm::mat4(1.0f), glm::vec3(i, 0.0, 0.0)); // controls the translation along Ox
